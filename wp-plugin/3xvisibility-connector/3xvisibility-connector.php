 ...
 * Description:        Secure companion plugin that lets the 3xVisibility SaaS publish native Elementor & Gutenberg pages, upload media, regenerate CSS, clear caches, and detect builders/themes — making programmatic pages behave exactly like pages built manually inside WordPress.
 * Version:           1.0.0
 * Author:            3xVisibility
 * Author URI:        https://3xvisibility.com
 * License:           GPL-2.0+
 * Text Domain:       3xvisibility-connector
 *
...
define( 'XXXV_CONNECTOR_NS', '3xv/v1' );
define( 'XXXV_CONNECTOR_OPT_KEY', 'xxxv_connector_api_key' );
define( 'XXXV_CONNECTOR_UPDATE_URL', 'https://3xvisibility.com/wp-plugin/update.json' );
