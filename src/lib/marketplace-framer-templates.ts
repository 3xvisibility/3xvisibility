...
<div class="al-page">
  ...
  return {
    ...
    og_title_pattern: "{company_name} — {hero_title}", og_description_pattern: "{hero_tagline} {company_name} blends strategy, design and technology to help brands stand out.", og_image_pattern: "{service_1_image}",
...
<div class="pw-page">
  ...
  return {
    ...
    og_title_pattern: "{company_name} — {hero_title}", og_description_pattern: "{hero_subtitle} {company_name} turns conversation into execution with trusted answers and instant actions.", og_image_pattern: "{split_1_image}",
...
<div class="fb-page">
  ...
  return {
    ...
    og_title_pattern: "{company_name}® — Creative Studio", og_description_pattern: "{statement}", og_image_pattern: "{project_1_image}",
...
<div class="hz-page">
  ...
  return {
    ...
    og_title_pattern: "{company_name} — {hero_line_1} {hero_line_2}", og_description_pattern: "{hero_subtitle} {company_name} delivers unlimited design for startups and brands.", og_image_pattern: "{work_1_image}",
