...
<div class="es">
  ...
  return {
    id: "real-estate-2", name: "Real Estate Template", description: "Premium real estate landing with property listings, pricing and stats.",
    content,
    variables: [
...
<div class="pl">
  ...
  return {
    id: "fitness-gym-2", name: "Fitness Gym Template", description: "High-energy gym & fitness landing with classes, pricing plans and bold type.",
    content,
    variables: [
...
<div class="sk">
  ...
  return {
    id: "saas-app", name: "SaaS App Template", description: "Clean SaaS product landing with app screenshot and feature grid.",
    content,
    variables: [
      "{eyebrow}", "{hero_title}", "{hero_subtitle}", "{cta_primary}", "{cta_secondary}", "{hero_image}",
...
<div class="sv">
  ...
  return {
    id: "restaurant", name: "Restaurant Template", description: "Warm fine-dining restaurant landing with full menu, gallery and reservations.",
    content,
    variables: [
      "{eyebrow}", "{hero_title}", "{hero_subtitle}", "{cta_primary}", "{cta_secondary}", "{hero_image}",
...
<div class="fr">
  ...
  return {
    id: "photography", name: "Photography Template", description: "Minimal masonry portfolio for photographers with gallery and stats.",
    content,
    variables: [
...
<div class="ln">
  ...
  return {
    id: "online-course-2", name: "Online Course Template", description: "Friendly online course landing with curriculum modules, stats and enrollment.",
    content,
    variables: [
      "{eyebrow}", "{hero_title}", "{hero_subtitle}", "{cta_primary}", "{cta_secondary}", "{hero_image}",
