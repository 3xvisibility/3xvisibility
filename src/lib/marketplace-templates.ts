...
const RAW_COMMUNITY_TEMPLATES: MarketplaceTemplate[] = [
  ...
  // 34. MarginFinder — premium operations-consulting landing (modelled on marginfinder.app)
  {
    id: "marginfinder-consulting",
    name: "MarginFinder — Operations Consulting",
    description: "Premium, editorial-style operations-consulting landing page for turnaround, PE-portfolio and margin-recovery firms. Dark navy + gold accent, split hero with 'As featured in' press strip, four-week methodology, client-result quotes with named executives and recovered-dollar figures, big trust stats and a confidential-assessment form. Modelled 1:1 on marginfinder.app.",
    ...
    variables: [
      ...
      "{result_1_quote}", "{result_1_metric}", "{result_1_context}", "{result_1_name}", "{result_1_role}", "{result_1_scale}",
      "{result_2_quote}", "{result_2_metric}", "{result_2_context}", "{result_2_name}", "{result_2_role}", "{result_2_scale}",
      "{result_3_quote}", "{result_3_metric}", "{result_3_context}", "{result_3_name}", "{result_3_role}", "{result_3_scale}",
      "{total_recovered}", "{engagements_count}", "{avg_roi}", "{time_to_result}",
      "{assessment_title}", "{assessment_body}",
      "{phone}", "{email}", "{address}",
    ],
    category: "professional",
    tags: ["consulting", "operations", "turnaround", "advisory", "b2b", "premium", "corporate", "editorial"],
    author: "Community", downloads: 0, rating: 5.0,
    slug_pattern: "operations-consulting-{city}",
    seo_title_pattern: "{company_name} — Operations Consulting in {city} | Margin Recovery",
    seo_description_pattern: "{sub_headline} {company_name} partners with $10M–$250M+ operators in {city}, {state} to recover margin. Confidential assessment — call {phone}.",
    og_title_pattern: "{company_name} — Operations Consulting | {headline}",
    og_description_pattern: "{sub_headline} Confidential diagnostic assessment with a {company_name} partner in {city}.",
    og_image_pattern: "",
    schema_type: "ProfessionalService",
    defaultValues: {
      company_name: "MarginFinder",
      tagline: "Operations Consulting",
      ...
      press_year: "2025",
      method_1_title: "Diagnostic Week",
      method_1_desc: "We walk the floor, read the P&L, and interview six levels of the org. By Friday we know where the margin is.",
      method_2_title: "Remediation Roadmap",
      method_2_desc: "A prioritized, sequenced plan with financial projections for each initiative. No theoretical frameworks — specific interventions.",
      method_3_title: "Embedded Execution",
      method_3_desc: "We don't hand you a deck. We sit in the room until the change is operational and the numbers prove it.",
      method_4_title: "Margin Verification",
      method_4_desc: "We return at 90 days to validate results against projections. Accountability is part of the engagement structure.",
      result_1_quote: "$4.2M recovered in supply chain waste, Q1 alone — we had been bleeding that for three years without knowing where.",
      result_1_metric: "$4.2M recovered",
      result_1_context: "Q1 alone",
      result_1_name: "Katherine Brennan",
      result_1_role: "COO, Hartwell Distribution",
      result_1_scale: "$180M revenue",
      result_2_quote: "Three portfolio companies. Eight months. $23M in EBITDA improvement. MarginFinder is the first call on every new acquisition.",
      result_2_metric: "$23M EBITDA lift",
      result_2_context: "3 companies, 8 months",
      result_2_name: "Marcus Delacroix",
      result_2_role: "Operating Partner, Redwood Capital Partners",
      result_2_scale: "PE Portfolio",
      result_3_quote: "They walked in on a Tuesday, had a prioritized remediation roadmap by Friday. The org chart overhaul alone cut decision time by 340%.",
      result_3_metric: "340% decision velocity",
      result_3_context: "90-day transformation",
      result_3_name: "Priya Nambiar",
      result_3_role: "CEO, Strata Manufacturing",
      result_3_scale: "$95M revenue",
      total_recovered: "$180M+",
      engagements_count: "34",
      avg_roi: "14:1",
      time_to_result: "6 wks",
      assessment_title: "Schedule your diagnostic conversation.",
      assessment_body: "A 45-minute call with a partner. We'll tell you where we think the margin is — before you decide whether to engage. No pitch. No obligation.",
      phone: "+1 (415) 555-0148",
      email: "partners@marginfinder.com",
      address: "One Market St, San Francisco, CA",
    },
  },
];
