...
const STRINGS: Record<InvoiceLocale, InvoiceStrings> = {
  fr: {
    ...
    colUnit: "PU HT",
    colTotal: "TOTAL HT",
    defaultItem: "Abonnement 3x Visibility",
  ...
  de: {
    ...
    colUnit: "EP NETTO",
    colTotal: "NETTO",
    defaultItem: "3x Visibility Abonnement",
  ...
  es: {
    ...
    defaultItem: "Suscripción 3x Visibility",
  ...
  en: {
    ...
    defaultItem: "3x Visibility subscription",
