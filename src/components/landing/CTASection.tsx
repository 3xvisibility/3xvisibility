      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <ScrollReveal>
          <div className="relative rounded-3xl overflow-hidden">
            ...
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,hsl(96,67%,48%,0.15),transparent_60%)]" />
            ...
            <div className="relative z-10 py-16 md:py-20 px-8 md:px-16 text-center">
              ...
              <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
                ...
                <Button variant="outline" size="lg" className="border-[hsl(96,67%,48%,0.2)] bg-transparent text-[hsl(220,12%,55%)] hover:text-foreground hover:bg-[hsl(96,67%,48%,0.08)] h-12 rounded-xl text-sm font-medium" asChild>
