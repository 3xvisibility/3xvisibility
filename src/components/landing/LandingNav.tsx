  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50">
      <motion.div
        ...
        className={`transition-all duration-500 ${scrolled ? "bg-white/92 backdrop-blur-2xl border-b border-[hsl(96,67%,48%,0.10)] shadow-[0_2px_20px_hsl(96,67%,48%,0.06)]" : "bg-white/70 backdrop-blur-xl"}`}
      >
              ...
              return (
                <a
                  ...
                  className={`text-sm px-4 py-2 rounded-lg transition-colors duration-200 font-medium ${
                    isActive
                      ? "text-primary bg-[hsl(96,67%,48%,0.1)]"
        ...
        <AnimatePresence>
          {mobileOpen && (
            <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: "auto" }} exit={{ opacity: 0, height: 0 }} transition={{ duration: 0.2 }} className="lg:hidden border-t border-[hsl(96,67%,48%,0.1)] overflow-hidden bg-[hsl(250,30%,100%)]/95 backdrop-blur-2xl">
                  ...
                  return (
                    <a
                      ...
                      className={`block text-sm py-2.5 px-3 rounded-lg transition-all ${
                        isActive
                          ? "text-primary bg-[hsl(96,67%,48%,0.1)]"
                          : "text-[hsl(220,12%,48%)] hover:text-foreground hover:bg-[hsl(96,67%,48%,0.08)]"
                      }`}
                      onClick={(e) => handleNavClick(e, l.href)}
                    >
                      {l.label}
