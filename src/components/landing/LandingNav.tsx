  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50">
      <motion.div
        ...
        className={`transition-all duration-500 ${scrolled ? "bg-white/92 backdrop-blur-2xl border-b border-[hsl(91,96%,43%,0.10)] shadow-[0_2px_20px_hsl(91,96%,43%,0.06)]" : "bg-white/70 backdrop-blur-xl"}`}
      >
        <div className="container mx-auto flex items-center justify-between h-16 px-4 lg:px-8">
          <Link to="/" className="flex items-center">
            <span className="group/logo relative inline-flex items-center rounded-full bg-[linear-gradient(135deg,hsl(240,18%,13%),hsl(245,22%,8%))] px-4 py-2 ring-1 ring-inset ring-white/10 shadow-[0_6px_20px_-8px_hsl(91,96%,30%,0.55)] transition-all duration-300 hover:ring-[hsl(96,92%,55%,0.45)] hover:shadow-[0_10px_28px_-8px_hsl(91,96%,40%,0.5)]">
              <span aria-hidden className="pointer-events-none absolute inset-0 rounded-full bg-[radial-gradient(120%_120%_at_0%_0%,hsl(96,92%,55%,0.22),transparent_60%)]" />
              ...
              return (
                <a
                  ...
                  className={`text-sm px-4 py-2 rounded-lg transition-colors duration-200 font-medium ${
                    isActive
                      ? "text-primary bg-[hsl(91,96%,43%,0.1)]"
          ...
          <div className="hidden lg:flex items-center gap-2">
            ...
            <Button variant="ghost" size="sm" className="text-sm h-9 px-4 rounded-lg font-medium text-[hsl(220,12%,48%)] hover:text-foreground hover:bg-[hsl(91,96%,43%,0.08)]" asChild>
        ...
        <AnimatePresence>
          {mobileOpen && (
            <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: "auto" }} exit={{ opacity: 0, height: 0 }} transition={{ duration: 0.2 }} className="lg:hidden border-t border-[hsl(91,96%,43%,0.1)] overflow-hidden bg-[hsl(250,30%,100%)]/95 backdrop-blur-2xl">
              <div className="px-4 py-4 space-y-1">
                  ...
                  return (
                    <a
                      ...
                      className={`block text-sm py-2.5 px-3 rounded-lg transition-all ${
                        isActive
                          ? "text-primary bg-[hsl(91,96%,43%,0.1)]"
                          : "text-[hsl(220,12%,48%)] hover:text-foreground hover:bg-[hsl(91,96%,43%,0.08)]"
                      }`}
                      onClick={(e) => handleNavClick(e, l.href)}
                    >
                      {l.label}
                ...
                <div className="pt-3 flex flex-col gap-2 border-t border-[hsl(91,96%,43%,0.1)] mt-3">
                  <LanguageSwitcher variant="outline" size="sm" className="justify-start gap-2 rounded-lg h-10 border-[hsl(91,96%,43%,0.15)]" />
                  <Button variant="outline" size="sm" className="rounded-lg h-10 border-[hsl(91,96%,43%,0.15)] text-foreground" asChild>
                    <Link to="/auth">{t("nav.login")}</Link>
                  </Button>
