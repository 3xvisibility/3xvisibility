    ...
    <section className="relative pt-32 pb-16 md:pt-40 md:pb-24 overflow-hidden">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          >
            Upload a CSV, map it to a template, and generate hundreds of
            SEO-optimized pages — deployed to WordPress or Shopify in minutes.
          </motion.p>
        ...
        >
          ...
          <div className="relative rounded-xl md:rounded-2xl overflow-hidden border border-border/40 bg-card shadow-2xl shadow-primary/5">
            ...
            <img
              src={heroImage}
              alt="PageGen dashboard showing CSV to page generation workflow"
