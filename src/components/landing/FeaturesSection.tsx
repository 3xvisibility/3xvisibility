      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          {features.map((f) => (
            <div
              key={f.title}
              className="group relative rounded-xl border border-border/50 bg-background p-6 md:p-7 hover:border-primary/30 hover:shadow-card-hover transition-all duration-300"
            >
