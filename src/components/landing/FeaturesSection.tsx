...
export function FeaturesSection() {
  ...
  return (
    <section id="features" className="py-20 md:py-28 relative">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_50%_40%_at_50%_0%,hsl(91,96%,43%,0.06),transparent)] pointer-events-none" />
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        >
          {featureConfigs.map((f) => (
            <motion.div
              key={f.titleKey}
              className="group relative rounded-2xl border border-[hsl(91,96%,43%,0.1)] bg-[hsl(250,30%,98%)] p-6 hover:border-[hsl(91,96%,43%,0.25)] transition-all duration-500 hover:bg-[hsl(250,30%,97%)]"
              variants={{
              ...
              whileHover={{ y: -4 }}
            >
              <div className="absolute inset-0 rounded-2xl bg-[radial-gradient(ellipse_at_center,hsl(91,96%,43%,0.04),transparent)] opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
              <div className="relative z-10">
                <div className="h-11 w-11 rounded-xl bg-[hsl(91,96%,43%,0.1)] border border-[hsl(91,96%,43%,0.15)] flex items-center justify-center mb-4 group-hover:scale-110 group-hover:bg-[hsl(91,96%,43%,0.15)] transition-all duration-300">
                  <f.icon className="h-5 w-5 text-[hsl(91,96%,32%)]" />
                </div>
