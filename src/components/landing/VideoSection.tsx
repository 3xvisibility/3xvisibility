    ...
    <section id="demo-video" className="py-20 md:py-28 relative overflow-hidden">
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <ScrollReveal className="text-center max-w-2xl mx-auto mb-12">
          ...
          <p className="mt-3 text-sm text-[hsl(220,12%,42%)]">{t("video.description")}</p>
        </ScrollReveal>
              ...
              {playing ? (
                ...
                <>
                  ...
                  <div className="absolute inset-0 cursor-pointer group bg-gradient-to-br from-[hsl(250,30%,99%,0.55)] to-[hsl(250,30%,99%,0.25)] flex flex-col items-center justify-center gap-4" onClick={() => setPlaying(true)}>
                    ...
                    <p className="text-sm font-medium text-[hsl(220,12%,62%)]">{t("video.watchDemo")}</p>
                  </div>
                </>
              )}
            </div>
        ...
        <ScrollReveal delay={0.2}>
          <div className="mt-14 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
            {[
              ...
              <div key={stat.labelKey} className="text-center py-5 rounded-2xl border border-[hsl(96,67%,48%,0.1)] bg-[hsl(250,30%,98%)]">
