...
export function FeatureShowcaseSection() {
  ...
  const showcases = [
    ...
    },
    {
      ...
      visual: (
        <div className="rounded-xl border border-[hsl(96,90%,45%,0.12)] bg-[hsl(220,40%,8%)] overflow-hidden">
  ...
  return (
    <section className="py-20 md:py-28 relative overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_60%_40%_at_50%_50%,hsl(96,90%,45%,0.04),transparent)] pointer-events-none" />
            ...
            <ScrollReveal key={item.step} direction={idx % 2 === 0 ? "left" : "right"}>
              <div className={`grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-14 items-center ${idx % 2 === 1 ? "lg:[direction:rtl] lg:*:[direction:ltr]" : ""}`}>
                ...
                <div className="relative">
                  <div className="absolute -inset-4 bg-[radial-gradient(ellipse_at_center,hsl(96,90%,45%,0.06),transparent)] rounded-2xl blur-2xl pointer-events-none" />
