...
export function UseCasesSection() {
  ...
  const useCases = [
    {
      ...
      gradient: "from-[hsl(96,67%,48%,0.15)] to-[hsl(96,67%,48%,0.08)]",
      borderColor: "border-[hsl(96,67%,48%,0.2)]",
      tagBg: "bg-[hsl(96,67%,48%,0.12)] text-[hsl(96,67%,35%)]",
    },
    {
      icon: Target,
      tag: "SEA",
  ...
  return (
    <section id="use-cases" className="py-20 md:py-28 relative overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_60%_40%_at_50%_30%,hsl(96,67%,48%,0.05),transparent)] pointer-events-none" />
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
                ...
                <div className="relative z-10 p-6 md:p-8">
                  <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-10 items-center">
                    ...
                    <div className="lg:col-span-3">
                      <div className="flex items-center gap-3 mb-4">
                        <div className={`h-9 w-9 rounded-xl bg-[hsl(250,30%,95%)] ${uc.borderColor} border flex items-center justify-center`}>
                          <uc.icon className="h-4 w-4 text-[hsl(96,67%,35%)]" />
                        </div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {uc.highlights.map((h) => (
                          <span
                            key={h}
                            className="text-[11px] font-medium text-[hsl(220,12%,48%)] bg-[hsl(250,30%,96%)] rounded-full px-3 py-1 border border-[hsl(96,67%,48%,0.1)]"
                          >
                            {h}
                          </span>
                        ))}
                    ...
                    <div className="lg:col-span-2">
                      <div className="rounded-xl border border-[hsl(96,67%,48%,0.12)] bg-[hsl(250,30%,99%)] overflow-hidden">
                        ...
                        <div className="p-4 font-mono text-[12px] text-[hsl(96,67%,35%)] leading-relaxed break-all">
                          {uc.example}
                        </div>
                      </div>
                    </div>
        ...
        >
          {audiences.map((a) => (
            <motion.div
              key={a.title}
              className="group relative rounded-2xl border border-[hsl(96,67%,48%,0.1)] bg-[hsl(250,30%,98%)] p-5 hover:border-[hsl(96,67%,48%,0.25)] transition-all duration-500"
              variants={{
              ...
              whileHover={{ y: -4 }}
            >
              <div className="h-10 w-10 rounded-xl bg-[hsl(96,67%,48%,0.1)] border border-[hsl(96,67%,48%,0.15)] flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                <a.icon className="h-5 w-5 text-[hsl(96,67%,35%)]" />
              </div>
