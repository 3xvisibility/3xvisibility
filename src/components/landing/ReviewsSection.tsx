...
function ReviewCard({ review }: { review: Review }) {
  return (
    <div className="flex-shrink-0 w-[300px] rounded-2xl border border-[hsl(96,67%,48%,0.1)] bg-[hsl(250,30%,98%)] p-5 hover:border-[hsl(96,67%,48%,0.2)] transition-all duration-300">
      ...
      <div className="flex items-center gap-3 pt-3 border-t border-[hsl(96,67%,48%,0.08)]">
        <div className="h-8 w-8 rounded-full bg-gradient-to-br from-[hsl(96,67%,48%,0.2)] to-[hsl(96,67%,48%,0.2)] flex items-center justify-center text-[10px] font-bold text-[hsl(96,67%,35%)]">
          {review.avatar}
        </div>
        <div>
