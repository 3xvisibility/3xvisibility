...
const ELEMENTS = [
  ...
  { id: "OSM", icon: MapPin, label: "OpenStreetMap", placeholder: "{city}", color: "text-primary", desc: "Embed an OpenStreetMap" },
  ...
  { id: "WEATHER", icon: Cloud, label: "Weather (OpenWeatherMap)", placeholder: "{city}, {state}", color: "text-primary", desc: "Show current weather via OpenWeatherMap" },
  ...
  { id: "GEMINI_IMAGE", icon: Star, label: "Gemini AI Image", placeholder: "{service} {city}", color: "text-primary", desc: "AI-generated image via Google Gemini" },
  ...
  { id: "IMAGE", icon: ImageIcon, label: "Dynamic Image", placeholder: "{keyword}", color: "text-primary", desc: "Insert an image by keyword" },
] as const;
