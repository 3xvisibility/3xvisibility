const hi: Record<string, string> = {
  "nav.features": "सुविधाएं", "nav.howItWorks": "कैसे काम करता है", "nav.pricing": "मूल्य", "nav.faq": "FAQ", "nav.login": "लॉगिन", "nav.getStarted": "शुरू करें",
  "hero.title1": "अपने डेटा को", "hero.title2": "प्रकाशित पृष्ठों में बदलें", "hero.cta": "मुफ्त में शुरू करें",
