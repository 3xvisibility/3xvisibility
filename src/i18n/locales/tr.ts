const tr: Record<string, string> = {
  "nav.features": "Özellikler", "nav.howItWorks": "Nasıl Çalışır", "nav.pricing": "Fiyatlar", "nav.faq": "SSS", "nav.login": "Giriş Yap", "nav.getStarted": "Başla", "nav.lightMode": "Açık mod", "nav.darkMode": "Koyu mod",
  "hero.badge": "Artık AI destekli içerik üretimi ile", "hero.title1": "Verilerinizi", "hero.title2": "yayınlanmış sayfalara dönüştürün", "hero.cta": "Ücretsiz başla", "hero.watchDemo": "Demo izle",
  "dashboard.search": "Ara...", "dashboard.settings": "Ayarlar", "dashboard.billing": "Faturalama", "dashboard.logout": "Çıkış",
