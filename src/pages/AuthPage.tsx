          ...
          >
            ...
            <div className="rounded-2xl border border-border/50 bg-card/80 backdrop-blur-sm shadow-xl shadow-primary/5 p-6 md:p-8">
              ...
              <Button
                ...
                disabled={loading}
                className="w-full h-11 rounded-xl border-border/60 bg-background/50 hover:bg-accent/50 font-medium text-sm transition-all duration-200 active:scale-[0.98]"
              >
